...
form.elements.name.minLength = '4';
form.elements.age.attributes.type.value = 'number';
form.elements.age.min = '18';
form.elements.age.max = '90';
...
const addNewEmployee = (e) => {
  ...
  if (Object.values(dataNewEmployee).includes('')) {
    pushNotification(10, 10, 'Error',
      'All fields are required', 'error');
  } else if (form.elements.name.value.length < 4) {
    pushNotification(10, 10, 'Error',
      'Please fill in the input Name.\n '
  + 'Minimum allowed number of characters: 4', 'error');
  } else if (+form.elements.age.value < 18 || +form.elements.age.value > 90) {
    pushNotification(10, 10, 'Error',
      'Please fill in the input Age.\n '
